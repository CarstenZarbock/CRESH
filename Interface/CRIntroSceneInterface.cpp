...
{
	Foreground_1 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Background\\IntroScene\\1.txt"), MAX_X + 0, 0);
	Foreground_2 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Background\\IntroScene\\1.txt"), MAX_X + MAX_X, 0);
	Cloud_1 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Objects\\Cloud_1.txt"), MAX_X + 0, 0);
	Cloud_2 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Objects\\Cloud_1.txt"), MAX_X + MAX_X, 0);

	Cloud_3 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Objects\\Cloud_2.txt"), MAX_X + 10, 2);
	Cloud_4 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Objects\\Cloud_2.txt"), MAX_X + 45, 7);
	Cloud_5 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Objects\\Cloud_2.txt"), MAX_X + 55, 5);
	Cloud_6 = new KRenderResourceImage(KRenderResourceImage::LoadImage("Content\\Objects\\Cloud_2.txt"), MAX_X + 75, 9);
...
void CRIntroSceneInterface::Tick(const float deltaTime)
{
	...
	static float foregroundSpeed = 34.f;
	static float frontCloudSpeed = 44.f;
